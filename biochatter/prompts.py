...
from .llm_connect import Conversation, GptConversation, AzureGptConversation
...
class AzureBioCypherPromptEngine(BioCypherPromptEngine):
    def __init__(
        self,
        schema_config_or_info_path: Optional[str] = None,
        schema_config_or_info_dict: Optional[dict] = None,
        ...
        Args:
            ...
            deployment_name: the deployment name of the azure OpenAI deployment
                that should be used.
        """
    ...
    def _get_conversation(
        ...
        version: Optional[str] = '2023-12-01-preview'
    ) -> "Conversation":
        """
        Create a conversation object given a model name.
